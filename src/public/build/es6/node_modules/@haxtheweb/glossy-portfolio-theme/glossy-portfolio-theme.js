...
import { html as o, css as t } from "../../lit/index.js";
import { HAXCMSLitElementTheme as e } from "../haxcms-elements/lib/core/HAXCMSLitElementTheme.js";
import { store as i } from "../haxcms-elements/lib/core/haxcms-site-store.js";
import { autorun as r, toJS as s } from "../../mobx/dist/mobx.esm.js";
import { DDDSuper as l } from "../d-d-d/d-d-d.js";
import { I18NMixin as a } from "../i18n-manager/lib/I18NMixin.js";
import { DDDVariables as n } from "../d-d-d/lib/DDDStyles.js";

import "../haxcms-elements/lib/ui-components/active-item/site-active-title.js";
import "../bootstrap-theme/lib/BootstrapBreadcrumb.js";
import "../haxcms-elements/lib/ui-components/navigation/site-breadcrumb.js";
...
export class GlossyPortfolioTheme extends l(a(e)) {
  static get tag() {
  ...
  constructor() {
    ...
    r((o) => {
      this.isHome = false;
      const t = s(i.activeItem);
      if (t && t.order === 0 && i.ancestorItem === null) {
        this.isHome = true;
      }
    });
  }
  ...
  disconnectedCallback() {
    if (this.__disposer) {
      for (const o in this.__disposer) {
        this.__disposer[o].dispose();
      }
    }
  ...
  firstUpdated(o) {
    ...
    const t = globalThis.DesignSystemManager.requestAvailability();
    t.addDesignSystem({
      name: "glossy-portfolio-theme",
      styles: [...GlossyPortfolioTheme.styles, n],
      fonts: [
    ...
    t.active = "glossy-portfolio-theme";
  }
  ...
  static get styles() {
    ...
    `]}render(){this.activeItem;return o`
